...
export default function middleware(req) {
  ...
  const hostname = req.headers.get('host'); // get hostname of request (e.g. demo.vercel.app)
  ...
  const currentHost =
    process.env.NODE_ENV === 'production' && process.env.VERCEL === '1'
      ? hostname
          .replace(`.vercel.app`, '') // you have to replace ".vercel.app" with your own domain if you deploy this example under your domain.
